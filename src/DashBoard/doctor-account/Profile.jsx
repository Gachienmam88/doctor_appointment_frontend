...
const Profile = ({ doctorData }) => {
    ...
    const addQualifications = (e) => {
        ...
        addItem('qualifications', {
            startingDate: '', endingDate: '', degree: 'PHD', university: 'MIT'
        })
    }
    ...
    const addExperience = (e) => {
        e.preventDefault()
        addItem('experiences', {
            startingDate: '', endingDate: '', position: 'Surgeon', hospital: 'MIT'
        })
    }
        ...
        <div>
            ...
            <form action="">
                ...
                <div className="mb-5">
                    ...
                    <input type="text" name='bio' value={formData.bio} onChange={handleInputChange} placeholder='Biography' className='form__input'
                    />
                </div>
                <div className="mb-5">
                ...
                <div className="mb-5">
                        ...
                        return (
                            <>
                                <div key={index}>
                                    ...
                                    <button onClick={e => deleteQualifications(e, index)} className='bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 mb-[38px] cursor-pointer '>
                                        <AiOutlineDelete />
                                    </button>
                                </div>
                            </>
                    ...
                    <button className='bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer' onClick={addQualifications}>
                        Add Qualifications
                    </button>
                </div>
                <div className="mb-5">
                        ...
                        return (
                            <>
                                <div key={index}>
                                    ...
                                    <button onClick={e => deleteExperience(e, index)} className='bg-red-600 p-2 rounded-full text-white text-[18px] mt-2 mb-[38px] cursor-pointer '>
                                        <AiOutlineDelete />
                                    </button>
                                </div>
                            </>
                                ...
                                <div key={index}>
                                    <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5'>
                                        ...
                                        <div className='flex items-center'>
                                            <button onClick={e => deleteTimeSlots(e, index)} className='bg-red-600 p-2 rounded-full text-white text-[18px]  mb-[38px] cursor-pointer mt-6'>
                                                <AiOutlineDelete />
                                            </button>
                                        </div>
                                    </div>
                ...
                <div className="mb-5">
                    ...
                    <textarea name="about" id="" className='form__input' value={formData.about} placeholder='Write about you '></textarea>
                </div>
