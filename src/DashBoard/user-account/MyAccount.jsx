...
const MyAccount = () => {
    ...
    const { data: userData, loading, err } = useGetProfile(`${BASE_URL}/users/profile/me`)
    ...
    return (
        <section>
            <div className='max-w-[1170px] px-5 mx-auto  '>
                ...
                {!loading && !err && <div className="grid md:grid-cols-3 gap-10 ">
                    <div className="pb-[50px] px-[30px] rounded-md  ">
                        <div className="flex items-center justify-center ">
                            <figure className='w-[100px] h-[100px] rounded-full border-2 border-solid border-primaryColor '>
                                <img src={userData.photo} alt="image" className='w-full h-full rounded-full ' />
                            </figure>
                        </div>
                        ...
                        <div className='mt-[50px] md:mt-[100px] '>
                            ...
                            <button className='w-full mt-4 bg-red-600 p-3 text-[16px] leading-7 rounded-md text-white '>Delete account</button>
                        </div>
                    </div>
