            ...
            <div className='px-4 mx-auto max-w-screen-md'>
                ...
                <form action="" className='space-y-8'>
                    ...
                    <div>
                        ...
                        <input type="email" id='subject' placeholder='Let us know how can we help you'
                            className='form__input mt-1' />
                    </div>
                    <div className='sm:col-span-2'>
                        <label htmlFor="text" className='form__label'>Your Message</label>
                        <textarea rows='6' name="" id="message"
                            type='text' placeholder='Leave a comment...' className='form__input mt-1' ></textarea>
                    </div>
