    ...
    return (
        <div>
                    ...
                    {qualifications?.map((item, index) => {
                        return (
                            <li key={index} className='flex flex-col sm:flex-row sm:justify-between sm:items-end md:gap-5 mb-[30px] '>
                                <div>
                                    <span className='text-irisColor text-[15px] leading-6 font-semibold  '>
            ...
            <div className="mt-12">
                ...
                <ul className='grid  md:grid-cols-2 xl:grid-cols-2  gap-[30px] pt-4 md:pt-5 '>
                    {experiences?.map((item, index) => {
                        return (
                            <li key={index} className='p-4 rounded bg-[#fff9ea] 
                 '>
                                <div className='text-yellowColor text-[15px] leading-6 font-semibold '>
                                    {formatDate(item.startingDate)}-{formatDate(item.endingDate)}
                                </div>
